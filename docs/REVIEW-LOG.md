...
**Gate**: `node docs/design/check.mjs` — **exit 0, all checks, both installs, every panel** — on the
merged tree; §13 copy corpus **6978** strings, `title` **406**, `aria-label` **468**, all
...
empty set, so the zero below is a zero over something. **Element rects compared 1,296,736,
